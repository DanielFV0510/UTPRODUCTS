			...
			<div class="row">
				...
				<div class="col-md-6 p-b-30" id="col-md-6 p-b-30">
					<form class="leave-comment" action="nuevoproducto.php" method="post" enctype="multipart/form-data">
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="file"  id="foto2" name="foto2" placeholder="FOTO - 2" onchange="return si2()">
						</div>

						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="file" id="foto3" name="foto3" placeholder="FOTO - 3" onchange="return si3()">
						</div>
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" id="Precio"  name="Precio" placeholder="Precio (ejm: 1.50 25.00)" maxlength="5" onpaste="return false" onkeypress="return sn(event)">
						</div>
