...
?>
	...
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(data:image/jpg;base64,<?php echo base64_encode($event['logo']) ?>);" >
...
<!-- 
					...
					$result= mysqli_query($mysqli,"select * from lista_usuarios lu inner join lista_productos lp on lu.id=lp.nomproy WHERE lu.id = '$iddes'");
					while ($event= mysqli_fetch_array($result)){ ?>
