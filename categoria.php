...
?>
                    <?php
             $result= mysqli_query($mysqli,"select * from categoria WHERE id = '$iddes'");
             while ($event= mysqli_fetch_array($result)){ 
                     echo $event['nombcateg'];
					}
		            ?>
        </h2>
    ...
    <section class="bgwhite p-t-55 p-b-65">
        <div class="container">
            <div class="row">
				...
				$productos = new Productos(15,'categoria',$iddes);	?>
                            TENEMOS UN TOTAL DE <?php echo $productos->mostrarTotalResultados(); ?> PRODUCTOS <br />

						</span>
                            <div class="row">
                                <?php $productos->mostrarProductosxCat($iddes)  ?>
                            </div>
                    ...
                    <div class="pagination flex-m flex-w p-t-26">
                        <?php $productos->mostrarPaginas('categoria',$id);	?>
                    </div>
                </div>
            </div>
    </section>
